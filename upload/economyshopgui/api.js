...
export class API {
    ...
    */
    async loadVersions(pl) {
        ...
        var response = await this.fetchWithTimeout("https://api.gpplugins.com:2096/val/getBetaVersions?plugin=" + pl, {
            method: 'GET',
            timeout: 15000
          });
...
*/
    async downloadBeta(pl, beta) {
      try {
      var response = await this.fetchWithTimeout("https://api.gpplugins.com:2096/val/download?plugin=" + pl + "&version=" + beta.getVersion(), {
            method: 'GET',
            timeout: 15000,
    ...
    */
    completeDownload(status) {
      ...
      setTimeout(function() {
        window.location.href = window.location.href.replace('.html', '') + '/thank-you'},
        2000);
      } else {
...
*/
    async verifyAsync(pl, beta) {
      ...
      this.click("https://api.gpplugins.com:2096/val/authorize?plugin=" + pl + "&version=" + beta.getVersion());
    }
